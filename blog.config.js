...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    'eadeaaba-db4d-4561-9055-c98a9bc4b016',
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://guderain.space', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客，王冠晰，王冠晰的博客，人工智能', // 网站关键词 英文逗号隔开
