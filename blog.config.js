...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'guderain', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通前端', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion-next-wine-psi.vercel.app/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '不要温柔的走向那个良夜', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'wy98447059@gmail.com', // 邮箱地址 例如mail@tangly1024.com
  ...
  WIDGET_PET_LINK:
    ...
    'https://cdn.jsdelivr.net/npm/live2d-widget-model-haru/01/assets/haru01.model.json', // 挂件模型地址 @see https://github.com/xiazeyu/live2d-widget-models
  ...
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || '我的自留地', // 站点描述，被notion中的页面描述覆盖
