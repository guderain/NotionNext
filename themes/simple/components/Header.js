...
export default function Header(props) {
  ...
  return (
    <header className='text-center justify-between items-center px-6 bg-white h-80 dark:bg-black relative z-10' style={{background-image:url('/public/images/home.webp')}}>
